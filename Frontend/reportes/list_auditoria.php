...
$consulta ="SELECT auditoria.id_auditoria, auditoria.id_usuario, auditoria.evento, auditoria.fecha, usuarios.usuario
            FROM auditoria JOIN usuarios ON usuarios.id_usuario = auditoria.id_usuario";
